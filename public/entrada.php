...
$required = ['id', 'editorial', 'colegio', 'codigo_centro', 'ubicacion', 'fecha_entrada', 'bultos'];
$labels = [
    'id' => 'ID',
    'editorial' => 'Editorial',
    'colegio' => 'Colegio',
        ...
        <section class="panel">
            ...
            <form method="POST" action="<?= htmlspecialchars(BASE_URL, ENT_QUOTES, 'UTF-8') ?>/entrada.php" class="form-grid">
                <div class="campo">
                    ...
                    <input id="id" name="id" type="number" min="1" required value="<?= htmlspecialchars($datos['id'], ENT_QUOTES, 'UTF-8') ?>">
                </div>
                <div class="campo">
                ...
                <div class="campo">
                    ...
                    <input id="destino" name="destino" type="text" value="<?= htmlspecialchars($datos['destino'], ENT_QUOTES, 'UTF-8') ?>">
                </div>
                <div class="campo">
