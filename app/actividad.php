...
function actividadBadge(string $tipoEvento): string
{
    return match ($tipoEvento) {
        ...
        'usuario_rechazado' => 'text-bg-danger',
...
function actividadEtiqueta(string $tipoEvento): string
{
    return match ($tipoEvento) {
        ...
        'usuario_creado', 'usuario_aprobado', 'usuario_activado', 'usuario_desactivado', 'usuario_rol', 'usuario_password', 'usuario_rechazado' => 'Usuario',
